...
const SERVICE_LINKS = [
  { href: '/services/mobile-diagnostics',     label: 'Mobile Diagnostics' },
  { href: '/services/brake-service',         label: 'Brake Service' },
  { href: '/services/battery-alternator',        label: 'Battery & Alternator' },
  { href: '/services/oil-change-mobile',  label: 'Mobile Oil Change' },
  { href: '/services/starter-repair',label: 'Starter Repair' },
...
const TRUST_ITEMS = [
  ...
  { icon: faBolt,         label: '12-Month Parts Warranty' },
];

const SOCIALS = [
  { href: 'https://facebook.com/baycallmobile', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/baycallmobile',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>BayCall Mobile Mechanics</span>
                <span className={styles.logoSub}>Waco, Texas</span>
              </div>
            </Link>

            <p className={styles.tagline}>
              Flat-rate pricing. Same-day service. Zero contracts — ever. Serving Central Texas homes and businesses since 2013.
            </p>

            <div className={styles.contactBlock}>
              <a href="tel:+12549401515" className={styles.phoneLink}
                onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Footer Phone', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faPhone} />
                (254) 940-1515
              </a>
              <a href="mailto:hello@baycallmobile.com" className={styles.emailLink}
                onClick={() => trackEvent({ eventType: 'email_click', elementLabel: 'Footer Email', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faEnvelope} />
                hello@baycallmobile.com
              </a>
              <span className={styles.addressLine}>
                <FontAwesomeIcon icon={faLocationDot} />
                1400 N Valley Mills Dr, Waco, TX 76710
              </span>
            </div>
