...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'BayCall Mobile Mechanics',
  address       = 'Waco, TX 76710',
  phone         = '(254) 940-1515',
  email         = 'service@baycallmobile.com',
  googleMapsUrl = 'https://maps.google.com/?q=Summit+Door+Pros+mobile mechanic+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed mobile mechanic technicians.
          </p>
        </div>
