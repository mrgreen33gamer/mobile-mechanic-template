...
const SERVICES = [
  { icon: faWrench,          label: 'Mobile Diagnostics' },
  { icon: faLink,            label: 'Brake Service' },
  { icon: faDoorOpen,        label: 'Battery & Alternator' },
  { icon: faCogs,            label: 'Mobile Oil Change' },
  { icon: faClipboardList,   label: 'Starter Repair' },
  { icon: faBuilding,        label: 'Pre-Purchase Inspection' },
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'ASE · Insured' },
  { icon: faStar,         text: '4.9★ · 2,100+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed BayCall Mobile Mechanics technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12549401515"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 940-1515', section: 'ContactForm-V1' })}>
                          Call (254) 940-1515
                        </a>
                      </span>
                    </div>
