...
export default function CTABanner({
  headline      = "Ready for a Mobile Mechanic Who Comes to You?",
  subline   = "Same-day appointments available. Fair upfront quotes — no hidden fees. Call now or book online.",
      ...
      <div className={styles.inner}>
        ...
        >
          <span className={styles.eyebrow}>
            ...
            Central Texas Mobile Mechanic Experts Since 2013
          </span>
