...
const INDUSTRIES = [
  { slug: 'fleet-managers',   label: 'Fleet Managers',       icon: faHouse },
  { slug: 'property-managers-vehicles',          label: 'Property Manager Vehicles', icon: faHardHat },
  { slug: 'rideshare-delivery', label: 'Rideshare & Delivery',     icon: faIndustry },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Mobile mechanic programs — built for how your industry actually works.',
  disableLinks = false,
