...
// BayCall Mobile Mechanics — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full mobile mechanic repair, brakes, batteries, oil changes, starters, and pre-purchase inspections across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full mobile mechanic coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Battery & brake service'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Fair Upfront Quotes · 12-Month Parts Warranty on Common Jobs as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Fair Upfront Quotes · 12-Month Parts Warranty on Common Jobs', 'ASE-certified'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable mobile mechanic service for Bellmead residents and businesses. Battery & brake service, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'ASE-certified mobile mechanic technicians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential mobile mechanic service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Mobile Mechanic repair, spring & cable repair, and shop power for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'Battery & brake service', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Mobile Mechanic repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service mobile mechanic coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial mobile mechanic.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial mobile mechanic in all areas?',
    answer: 'Yes — light commercial mobile mechanic for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Mobile Mechanic — Since 2013
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Fair upfront quotes, ASE-certified technicians, and a 12-month parts warranty on common jobs — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12549401515" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common mobile mechanic issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12549401515" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12549401515" className={styles.unlistedCTA}>
            Call (254) 940-1515
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Fair Upfront Quotes · 12-Month Parts Warranty on Common Jobs, no contracts ever."
